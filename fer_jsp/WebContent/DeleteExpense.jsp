...
<% 
	...
	if(expenses==null || expenses.isEmpty() ) {
		...
		for(Expense expense:expenses) {
			value=expense.getId();
			description=expense.getId()+","+expense.getExpenseType()+","+expense.getDate()+","+expense.getPrice()+","+expense.getNumberOfItems()+","+expense.getTotal()+" and "+expense.getByWhom();
			out.println("<option value='"+value+"'>"+description+"</option>");
		}
		out.println("</select>");
		out.println("<input type=\"button\"value=\"delete Expense\"onclick=\"javascript: validateForm()\">");
